...
// import { UserAnswerSelector, UserSubmitAnswer } from "../../states/selectors/UserJoinAnswerPlaySelector";
const PlayChoices = () => {
  ...
  const handleSuccess = () => {
    ...
    if (indexParams + 1 <= questionLength) {
      navigate(`/play-choices-next/${indexParams + 1}`);
    } else {
